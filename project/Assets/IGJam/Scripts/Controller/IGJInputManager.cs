...
public class IGJInputManager : MonoBehaviour 
{
	...
	private void Update () {
        ...
        {
            Debug.Log("\tp1_input_vec: " + p1_inputVec + "\tp1_dir: " + p1_dirVec + "\n\tp1_actionPressed: " + p1_actionPressed + "\n\tp1_actionJustPressed: " + p1_actionJustPressed);
        }
        ...
        {
            Debug.Log("\tp3_input_vec: " + p3_inputVec + "\tp3_dir: " + p3_dirVec + "\n\tp3_actionPressed: " + p3_actionPressed + "\n\tp3_actionJustPressed: " + p3_actionJustPressed);
        }
        ...
        {
            Debug.Log("\tp4_input_vec: " + p4_inputVec + "\tp4_dir: " + p4_dirVec + "\n\tp4_actionPressed: " + p4_actionPressed + "\n\tp4_actionJustPressed: " + p4_actionJustPressed);
        }
