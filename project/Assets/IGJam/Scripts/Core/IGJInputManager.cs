...
public class IGJInputManager : MonoBehaviour 
{
	...
	private void Update () {
        ...
        {
            Debug.Log("\tp1_input_vec: " + p1_inputVec + "\tp1_dir: " + p1_dirVec + "\tp1_direction: " + p1_direction + "\tp1_actionPressed: " + p1_actionPressed + "\tp1_actionJustPressed: " + p1_actionJustPressed);
        }
